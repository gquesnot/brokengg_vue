...
import { A as ApplicationLogo } from "./ApplicationLogo-a13ec695.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Slot = resolveComponent("Slot");
      ...
      _push(`</div><div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg"><div class="text-4xl">TEST</div>`);
      _push(ssrRenderComponent(_component_Slot, null, null, _parent));
      _push(`</div></div>`);
    };
  }
});
