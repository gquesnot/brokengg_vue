...
import { _ as _sfc_main$4 } from "./AlertApi-748a9f42.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex justify-center items-center min-h-screen bg-dots-darker bg-center">`);
      _push(ssrRenderComponent(_component_v_card, { class: "w-1/2 p-8" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="bg-gray-1"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_v_card_text, { class: "flex flex-col items-center justify-center" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="flex mx-auto items-center w-fit"${_scopeId2}><div${_scopeId2}>`);
                  ...
                  return [
                    ...
                    createVNode("div", { class: "flex mx-auto items-center w-fit" }, [
            ...
            return [
              createVNode("div", { class: "bg-gray-1" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Summoner/Index.vue");
