        ...
        <v-window v-model="tab">
            ...
            <v-window-item value="team_analysis">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <CircularStat description="Gold Earned" :split_number="true"
                                  :participants="summoner_match.match.participants"
                    ...
                    <CircularStat description="CS" :split_number="false"
                                  :participants="summoner_match.match.participants"
                                  key_stat="minions_killed"/>
                </div>
            </v-window-item>
            <v-window-item value="build">
                <MatchDetailBuild v-if="match_detail !== null" :summoner_match="summoner_match"
